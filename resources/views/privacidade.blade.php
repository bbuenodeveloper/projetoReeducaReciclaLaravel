                ...
                <div class="card-body">
                    <div class="media media-intro">
                        ...
                        <div class="media-body">
                          <center> <h4>Politica de Privacidade</h4></center>
                    ...
                    <div id="accordion-one" class="accordion default-accordion-style">
                        <div class="card">
                            ...
                            <div id="collapseOne" class="collapse" data-parent="#accordion-one" style="">
                                <div class="card-body">
                                    ...
                                    <p>A garantia da confidencialidade dos dados pessoais dos utilizadores do nosso site é importante para o Reeduca Recicla.</p>
                                    <p>Todas as informações pessoais relativas a membros, assinantes, clientes ou visitantes que usem o Reeduca Recicla serão tratadas em concordância com a Lei da Proteção de Dados Pessoais de 26 de outubro de 1998 (Lei n.º 67/98).</p>
                                    ...
                                    <p>O uso do Reeduca Recicla pressupõe a aceitação deste Acordo de privacidade. A equipa do Reeduca Recicla reserva-se ao direito de alterar este acordo sem aviso prévio. Deste modo, recomendamos que consulte a nossa política de privacidade com regularidade de forma a estar sempre atualizado.</p>
                        ...
                        <div class="card">
                            ...
                            <div id="collapseThree" class="collapse" data-parent="#accordion-one" style="">
                                <div class="card-body">
                                    ...
                                    <p>Os utilizadores podem desativar o cookie DART visitando a Política de <a href='http://politicaprivacidade.com/' title='privacidade da rede de conteúdo'>privacidade da rede de conteúdo</a> e dos anúncios do Google.
                        ...
                        <div class="card">
                            ...
                            <div id="collapseFive" class="collapse" data-parent="#accordion-one">
                                <div class="card-body">
                                    <p>O Reeduca Recicla possui ligações para outros sites, os quais, a nosso ver, podem conter informações / ferramentas úteis para os nossos visitantes. A nossa política de privacidade não é aplicada a sites de terceiros, pelo que, caso visite outro site a partir do nosso deverá ler a politica de privacidade do mesmo.</p>
