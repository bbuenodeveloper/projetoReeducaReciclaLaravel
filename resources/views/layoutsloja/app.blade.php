                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active grow efeitoTransicaoLoja" href="/home">Home</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link active grow efeitoTransicaoLoja" href="/mapa">Mapa</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link active grow efeitoTransicaoLoja" href="/loja">Loja</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link active grow efeitoTransicaoLoja" href="/sobre">Sobre</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link active grow efeitoTransicaoLoja" href="/contato">Contato</a>
                            </li>
                            ...
                            @guest
                            <li class="nav-item">
                                <a class="nav-link active grow efeitoTransicaoLoja" href="{{ route('login') }}">{{ __('Login') }}</a>
                            </li>
