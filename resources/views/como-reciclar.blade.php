...
$facebook_image = htmlentities($root . 'img/' . $foto);?>
    ...
    <div class="carousel-inner">
      ...
      <div class="carousel-item">
        ...
        <div class="carousel-caption d-none d-md-block class="copy">
          <p>Garrafas plásticas<strong> não são lixo.</strong></p>
        </div>
      </div>
      <div class="carousel-item">
  ...
  <div class="meet-members">
    <div class="wrapper"><h2>Aprenda como reciclar<b> cada tipo de material</b></h2><p><p>Nos cards abaixo, você pode aprender como reciclar cada tipo de material, escolha o material, clique no sinal de + e tenha todas as informações necessárias para reciclar de forma correta.</p> 
