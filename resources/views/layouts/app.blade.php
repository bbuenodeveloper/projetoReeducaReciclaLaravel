                ...
                <ul class="nav marginHeader justify-content-end">
                    ...
                    <li class="nav-item">
                        <a class="nav-link grow efeitoTransicao" href="contato">Contato</a>
                                    ...
                                    @guest
                                    <li class="nav-item">
                                        <a class="nav-link grow efeitoTransicao" href="{{ route('login') }}">{{ __('Login') }}</a>
                                    </li>
                                    @if (Route::has('register'))
                                    <li class="nav-item">
                                        <a class="nav-link grow efeitoTransicao" href="{{ route('register') }}">{{ __('Registro') }}</a>
                                    </li>
                                    @endif
                                    @else
            ...
            <div class="row col-12 no-gutters">
                ...
                <div class="collapse navbar-collapse " id="navbarTogglerDemo02">
                    <ul class="navbar-nav mr-auto mt-2 mt-lg-0 text-center">
                        <li class="nav-item">
                            <a class="nav-link headerBurg" href="home.php">Home</a>
                        </li>
                        <li class="nav-item">
